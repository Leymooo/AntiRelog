...
public class Settings extends Config {
    ...
    @Comment("Кулдавн для обычных золотых яблок. -1 чтобы отключить кулдавн")
    public int          GOLDEN_APPLE_COOLDOWN           = 30;

    @Comment("Кулдавн для зачарованых золотых яблок. -1 чтобы отключить кулдавн")
    public int          ENCHANTED_GOLDEN_APPLE_COOLDOWN = 60;

    @Comment("Кулдавн для эндер перлов(Жемчуг Края). -1 чтобы отключить кулдавн")
